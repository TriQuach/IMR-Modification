...
//	    System.out.println("resultSeries is " + resultSeries);
  ...
  public static void main(String[] args) {
	  ...
	  try{    
          FileWriter fw=new FileWriter("outputRepair.txt");  
          
          String id = args[0];
          String prop = args[1];
          String order = args[2];
          double delta = Double.parseDouble(args[3]);
          int maxNumIterations = Integer.parseInt(args[4]);			
          
          String nameCell = id.concat("_").concat(prop);        		            
    		  double repairVal = getLastRepairValueOnCell(nameCell.concat(".txt"),delta,maxNumIterations);    		 
    		  fw.write(nameCell.concat("_").concat(String.valueOf(repairVal)));
    		  System.out.println(repairVal);
